...
public final class BusinessMessagesMessage extends com.google.api.client.json.GenericJson {
   ...
   * message. Maximum 13 suggestions.
   *
   * The chips only display when the associated message is the most recent message within the
   * conversation (including both agent and user messages). The user can tap a suggested reply to
   * send the text reply to the agent.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
