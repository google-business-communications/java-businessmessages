...
public class Businessmessages extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Conversations {
    ...
    public class Events {
       ...
       *
       * @param parent Required. The conversation that contains the message. Resolves to
    ...
    public class Surveys {
       ...
       *
       * If an agent sends multiple surveys in the same conversation within 24 hours, surveys after the
       * first return a `RESOURCE_EXHAUSTED` error.
       *
       ...
       * optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
       *
       * @param parent Required. The conversation that contains the survey. Resolves to
      "conversations/{conversationId}".
